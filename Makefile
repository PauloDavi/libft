...
MATH_SRC := ft_atoi.c ft_atof.c ft_nbrlen.c ft_unbrlen.c
CHAR_SRC := ft_isalnum.c ft_isascii.c ft_isprint.c ft_isalpha.c ft_isdigit.c
CHAR_SRC += ft_toupper.c ft_tolower.c ft_isspace.c ft_islower.c ft_isupper.c
LIST_SRC := ft_lstclear.c ft_lstdelone.c ft_lstadd_front.c ft_lstnew.c ft_lst_reverse.c
LIST_SRC += ft_lst_to_array.c ft_lstlast.c ft_lstsize.c ft_lstiter.c ft_lst_sort.c
