...
LIST_SRCC := ft_lstclear.c ft_lstdelone.c ft_lstadd_front.c ft_lstnew.c ft_lstmap.c ft_lstrm.c
LIST_SRCC += ft_lst_to_array.c ft_lstlast.c ft_lstsize.c ft_lstiter.c ft_lstadd_back.c
