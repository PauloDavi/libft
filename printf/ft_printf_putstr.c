...
/*   Updated: 2023/07/20 21:50:33 by pdavi-al         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_printf_putstr_space(const char *str, int len, int s,
				t_element element);
...
int	ft_printf_putstr(const char *str, t_element element)
{
	...
	if (spaces > 0)
		return (ft_printf_putstr_space(s, len, spaces, element));
	spaces = len;
	while (spaces--)
		write(1, s++, 1);
	return (len);
